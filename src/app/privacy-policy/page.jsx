...
const PrivacyPolicy = () => {
  return (
    <div className={styles.container}>
      ...
      <p className={styles.content}>For the purposes of this Privacy Policy:</p>
      ...
      <h3 className={styles.title}>Types of Data Collected</h3>
      <h4 className={styles.title}>Personal Data</h4>
      <p className={styles.content}>
      ...
      <h4 className={styles.title}>Usage Data</h4>
      <p className={styles.content}>
      ...
      <h4 className={styles.title}>Tracking Technologies and Cookies</h4>
      <p className={styles.content}>
      ...
      <h3 className={styles.title}>Use of Your Personal Data</h3>
      <p className={styles.content}>
      ...
      <h3 className={styles.title}>Retention of Your Personal Data</h3>
      <p className={styles.content}>
      ...
      <h3 className={styles.title}>Transfer of Your Personal Data</h3>
      <p className={styles.content}>
      ...
      <h3 className={styles.title}>Delete Your Personal Data</h3>
      <p className={styles.content}>
      ...
      <h3 className={styles.title}>Disclosure of Your Personal Data</h3>
      <h4 className={styles.title}>Business Transactions</h4>
      <p className={styles.content}>
      ...
      <h4 className={styles.title}>Law enforcement</h4>
      <p className={styles.content}>
        Under certain circumstances, the Company may be required to disclose
        Your Personal Data if required to do so by law or in response to valid
        requests by public authorities (e.g. a court or a government agency).
      </p>
      <h4 className={styles.title}>Other legal requirements</h4>
      <p className={styles.content}>
      ...
      <h3 className={styles.title}>Security of Your Personal Data</h3>
      <p className={styles.content}>
