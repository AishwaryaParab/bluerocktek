...
const TermsAndConditions = () => {
  return (
    <div className={styles.container}>
      ...
      <p className={styles.content}>Last updated: June 11, 2025</p>
      <p className={styles.content}>
        Please read these terms and conditions carefully before using Our
        Service.
      </p>
      <h2 className={styles.title}>Interpretation and Definitions</h2>
      <h3 className={styles.title}>Interpretation</h3>
      <p className={styles.content}>
      ...
      <h3 className={styles.title}>Definitions</h3>
      <p className={styles.content}>
      ...
      <ul className={styles.list}>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Maschtek, Goa, India.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Maschtek, accessible from{" "}
            <a
              className={styles.link}
              href="https://www.maschtek.com"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://www.maschtek.com
            </a>
          </p>
        </li>
        <li>
      ...
      <h2 className={styles.title}>Acknowledgment</h2>
      <p className={styles.content}>
      ...
      <h2 className={styles.title}>Termination</h2>
      <p className={styles.content}>
      ...
      <h2 className={styles.title}>Disputes Resolution</h2>
      <p className={styles.content}>
      ...
      <h2 className={styles.title}>For European Union (EU) Users</h2>
      <p className={styles.content}>
        If You are a European Union consumer, you will benefit from any
        mandatory provisions of the law of the country in which You are
        resident.
      </p>
      <h2 className={styles.title}>United States Legal Compliance</h2>
      <p className={styles.content}>
      ...
      <h2 className={styles.title}>Severability and Waiver</h2>
      ...
      <h3 className={styles.title}>Waiver</h3>
      <p className={styles.content}>
      ...
      <h2 className={styles.title}>Translation Interpretation</h2>
      <p className={styles.content}>
      ...
      <h2 className={styles.title}>Changes to These Terms and Conditions</h2>
      <p className={styles.content}>
      ...
      <ul className={styles.list}>
        <li>
          <p>By email: sales@maschtek.com</p>
        </li>
        <li>
          <p>By phone number: +91 7447338881</p>
        </li>
      </ul>
    </div>
  );
